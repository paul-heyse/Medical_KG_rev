...
class BatchOnly:
    ...
    def embed_documents(self, texts: list[str]) -> list[list[float]]:  # pragma: no cover - invoked via delegate helper
    ...
    def embed(self, texts: list[str]) -> list[list[float]]:  # pragma: no cover - invoked via delegate helper
...
class QueryOnly:
    ...
    def embed_query(self, text: str) -> list[float]:  # pragma: no cover - invoked via delegate helper
    ...
    def embed_queries(self, texts: list[str]) -> list[list[float]]:  # pragma: no cover - invoked via delegate helper
...
class LlamaStyle:
    ...
    def get_text_embedding(self, text: str) -> list[float]:  # pragma: no cover - invoked via delegate helper
